...
the constraint file ```nexys7.xdc``` that includes the pin definitions.
...
### Five Input Majority Encoder

Your task is to extend the provided 3 input majority encoder to a 5 input encoder and implement it onto the FPGA board.
