...
#set_property PACKAGE_PIN E21 [get_ports {clock}]


###set_property IOSTANDARD DIFF_SSTL15 [get_ports clk200_p]
###set_property -dict { PACKAGE_PIN AD12    IOSTANDARD DIFF_SSTL15} [get_ports { clock }]; # IO_L12P_T1_MRCC_35 Sch=clk100mhz
###create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {clock}];

## LEDs
set_property IOSTANDARD LVCMOS15 [get_ports {io_led}]
set_property PACKAGE_PIN AB8 [get_ports {io_led}]

###set_property -dict { PACKAGE_PIN AB8   IOSTANDARD LVCMOS25 } [get_ports { io_led }];  # IO_L18P_T2_A24_15 Sch=io_led
...
###set_property -dict { PACKAGE_PIN Y29   IOSTANDARD LVCMOS15 } [get_ports { reset }]; #IO_L4N_T0_D05_14 Sch=btnu
