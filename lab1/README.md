 ...
 * At the *Add Constraints* dialog box clock *Add Files* and select
   ```nexys7.xdc``` and press *OK*.
   * For the following labs you will need to edit the constraints file derived
     from the naxys7ddr Master constraints file.
 * Click *Next*
 * In the *Default Part* dialog box select *Parts* and *xc7k325tffg900-2*, press *Next*
 ...
 * Connect your nexys7 board with the USB cable to your laptop
